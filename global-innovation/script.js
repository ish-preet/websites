...
class GlobalInnovationUniversity {
  ...
  setupAnimations() {
    ...
    document
      .querySelectorAll('.feature, .program-card, .step, .stat-item')
      .forEach((el) => {
        observer.observe(el);
      });
  }
    ...
    const fallbackCourses = [
      {
        ...
        description:
          'Comprehensive education in humanities, social sciences, and natural sciences with interdisciplinary approach.',
        duration: '3-4 Years',
        type: 'BA/BSc',
      },
      {
        ...
        description:
          'Develop leadership skills and business acumen through case studies and industry projects.',
        duration: '2 Years',
        type: 'MBA',
      },
      {
        ...
        description:
          'Foundation in engineering principles with specialization in emerging technologies.',
        duration: '4 Years',
        type: 'BTech',
      },
      {
        ...
        description:
          'Rigorous program in medical education with clinical training and research opportunities.',
        duration: '5.5 Years',
        type: 'MBBS',
      },
      {
        name: 'Law & Governance',
        description:
          'Comprehensive legal education with moot courts and internship programs.',
        duration: '5 Years',
        type: 'BA LLB',
      },
      {
        ...
        description:
          'Creative program focusing on sustainable design and architectural innovation.',
        duration: '5 Years',
        type: 'BArch',
      },
    ];
  ...
  validateForm() {
    ...
    if (!document.getElementById('consent').checked) {
      this.showFormMessage(
        'Please consent to receive information about our programs and admission updates.',
        'error'
      );
      return false;
    }
  ...
  async submitFormData(formData) {
    const submitBtn = document.querySelector('#leadForm .btn-submit');
    const originalText = submitBtn.innerHTML;

    submitBtn.innerHTML =
      '<i class="fas fa-spinner fa-spin"></i> Submitting Inquiry...';
  ...
  showSuccessMessage() {
    this.showFormMessage(
      '✅ Thank you for your inquiry! Our admission team will contact you within 24 hours to guide you through the application process.',
      'success'
    );
  }
  ...
  showErrorMessage() {
    this.showFormMessage(
      '❌ We apologize for the inconvenience. There was an error submitting your inquiry. Please try again or contact our admission office at admissions@globalinnovation.edu.in',
      'error'
    );
  }
